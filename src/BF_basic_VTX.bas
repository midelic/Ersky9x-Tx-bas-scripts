...
if currentPage = 3
	...
	elseif currentLine = 2
		if val < 1 
			val = 5
		elseif val > 5 
			val = 1
		end
	elseif currentLine = 4
		if val < 1 
			val = 8
		elseif val > 8 
			val = 1
...
drawtext( 4, 15, "Dev", 0 )
drawtext( 4, 26, "Band", 0 )
drawtext( 4, 37, "Channel", 0 )

drawtext( 85, 15, "Power", 0 )
drawtext( 85, 26, "FREQ", 0 )

j = 1
gosub selectone
if values_vtx[j] = 1
drawtext( 60, 15, "6705", text_options )
elseif values_vtx[j] = 3
drawtext( 60, 15, "TBS", text_options )
elseif values_vtx[j] = 4
drawtext( 60, 15, "Tramp", text_options )
else
drawtext( 60, 15, "None", text_options )
end

j += 1
gosub selectone
drawnumber( 60, 26, values_vtx[j], text_options)
j += 1
gosub selectone
drawnumber( 60, 37, values_vtx[j], text_options )
j += 1
gosub selectone
drawnumber( 125, 15, values_vtx[j], text_options )
j += 1
gosub selectone
drawnumber( 125, 26, values_vtx[j], text_options )
rem todo... 
