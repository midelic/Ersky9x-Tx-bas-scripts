...
gState = PAGE_DISPLAY
	...
	array   values_vtx[32]
	rem array values_vtx_rx[32]
	array  byte values_vtx_received[32]
...
rem ---ignore write for now
 ...
 elseif page = 3
values_vtx_received[j] = mspRxBuf[j] 
gosub convertReceivedVtxValues
 end
 j += 1
 end
 end
...
convertReceivedVtxValues:
	rem //Type
	values_vtx[5] = values_vtx_received[1]
	rem //Band
	values_vtx[1] = values_vtx_received[2]
	rem //Channel
	values_vtx[2] = values_vtx_received[3]
	rem //Power
	values_vtx[3] = values_vtx_received[4]
	rem //Pitmode
	values_vtx[4] = values_vtx_received[5]
	rem //Freq
	values_vtx[6] = values_vtx_received[6] + values_vtx_received[7]*256
return
...
elseif page = 3
drawtext( 0, 0, "Betaflight / VTX", INVERS )
drawtext( 111, 0, "3/5", 0 )
...
drawtext( 64, 24, "Freq:", 0 )
		...
		elseif values_vtx[j] = 3
			drawtext(100, 14, "SA", text_options) rem TBS Smart Audio
		elseif values_vtx[j] = 4
			drawtext(100, 14, "TR", text_options) rem Tramp
		else
...
rem drawnumber(40, 11, payloadTx[1], 0)
	rem 	drawnumber(40, 11, mspRxBuf[1], 0)
	        drawtext( 20, 11, "Ch=", 0 )
		    drawnumber(60, 11, values_vtx[2], 0)
			
			
rem drawnumber(40, 21, payloadTx[2], 0)
rem 	drawnumber(40, 21, mspRxBuf[2], 0)
       drawtext( 20, 21, "freq=", 0 )
      drawnumber(60,21 ,values_vtx[6],0)
	  
rem drawnumber(40, 31, payloadTx[3], 0)  
         rem drawnumber(40, 31, mspRxBuf[3], 0) 
	  drawtext( 20, 31, "vtx1=", 0 )
	  drawnumber(60,21 ,values_vtx[1],0)
	  
rem drawnumber(40, 41, payloadTx[4], 0)
		rem drawnumber(40, 41, mspRxBuf[4], 0)
		
rem drawnumber(100, 11, payloadTx[5], 0)
        rem drawnumber(100, 11, mspRxBuf[5], 0)
		
	  
rem drawnumber(100, 21, payloadTx[6], 0)
		rem drawnumber(100, 21, mspRxBuf[6], 0)
		rem drawnumber(40, 51,  mspRxBuf[7], 0)		
		rem drawnumber(100,31,mspRxBuf[8],0)				
return
